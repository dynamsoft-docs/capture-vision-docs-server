...
# Dynamsoft Capture Vision API Reference - Java Edition
...
- [`LabelRecognizerModule`]({{ site.dlr_java_api }}label-recognizer-module.html)
...
- [`DocumentNormalizerModule`]({{ site.ddn_java_api }}document-normalizer-module.html)
...
- [`EnumImageColourMode`]({{ site.ddn_java_api }}enum-image-colour-mode.html)

## DynamsoftCodeParser

### Classes

- [`CodeParserModule`]({{ site.dcp_java_api }}code-parser-module.html)
- [`ParsedResultItem`]({{ site.dcp_java_api }}parsed-result-item.html)
- [`ParsedResult`]({{ site.dcp_java_api }}parsed-result.html)

### Enums

- [`EnumCodeType`]({{ site.dcp_java_api }}enum-code-type.html)
- [`EnumMappingStatus`]({{ site.dcp_java_api }}enum-mapping-status.html)
- [`EnumValiadtionStatus`]({{ site.dcp_java_api }}enum-validation-status.html)
