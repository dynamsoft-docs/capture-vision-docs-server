...
- [`MappingStatus`]({{ site.dcv_enumerations }}code-parser/mapping-status.html?src=cpp&&lang=cpp)
...
- [`ValiadtionStatus`]({{ site.dcv_enumerations }}code-parser/validation-status.html?src=cpp&&lang=cpp)
