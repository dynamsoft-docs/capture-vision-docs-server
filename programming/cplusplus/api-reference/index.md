...
- [`CaptureState`]({{ site.enumerations }}capture-vision-router/capture-state.html?src=cpp&&lang=cpp)
...
- [`GrayscaleEnhancementMode`]({{ site.enumerations }}core/grayscale-enhancement-mode.html?src=cpp&&lang=cpp)
...
- [`MappingStatus`]({{ site.enumerations }}code-parser/mapping-status.html?src=cpp&&lang=cpp)
...
- [`ValiadtionStatus`]({{ site.enumerations }}code-parser/validation-status.html?src=cpp&&lang=cpp)
