...
- [`ImageColourMode`]({{ site.dcv_enumerations }}document-normalizer/image-colour-mode.html?lang=cpp)
...
- [`ValiadtionStatus`]({{ site.dcv_enumerations }}code-parser/validation-status.html?lang=cpp)
